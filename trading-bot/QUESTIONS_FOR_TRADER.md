...
> ## STATUS — only two of these fifteen still need him.
>
> The recordings were re-mined against all fifteen (`answers/part1.md`, `part2.md`, `part3.md`) and
> **thirteen came back with an answer**, applied and recorded in `CHANGELOG_EVIDENCE.md`. If you are
> sending this to him, **send only Q6's first half and Q13** — the rest have been answered from his
> own words and asking them again would be asking him to repeat himself.
>
> **Q6 (the candle count only).** There is no fractal width, lookback or N-bar rule anywhere in the
> eight sessions; his swing points are ordinal and explicitly multi-valued (*"It doesn't matter which
> one"*, S6 `[01:21:06]`). The rest of Q6 **is** answered: structure off bodies, the SFP raid level
> and stop off the wick (S7 `[01:14:44]`), and "directional change" scaled by his own sufficient-gap
> table.
>
> **Q13 (2H, 4H, 8H, 12H).** Nothing is given for any of them, and they cannot be interpolated from
> the rows he did give — his 1H→1D and 1D→2D slopes disagree by a factor of three. One side-finding:
> the 30m row in the spec was **wrong** (3.5), and his own words give 4 % (S5 `[00:54:07]`).
>
> One of the thirteen was not a question at all but a **live defect**: Q8's 10 % was his *margin*
> percentage being enforced as a *notional* ceiling, under-risking every leverage trade by roughly
> five times. That is fixed and regression-tested.
