...
-- ============================================================
-- Combines migrations 01-04 so the whole setup is ONE copy-paste
...
-- After running: sign UP in the app first with your own email --
-- the first account creates the first organisation and adopts
-- all the seeded JNR data.
-- ============================================================
